...
$.fn.editInPlace.defaults = {
	...
	bg_over:			"rgba(0, 0, 0, 0.1)", // string: background color of hover of unactivated editor
	...
	default_text:		false, // string: text to show up if the element that has this functionality is empty
